...
public class ApiEndpoints
{
    ...
    public TranslationApiConfig EnglishToPersian { get; set; } = new()
    {
        ...
        {
            "http://127.0.0.1:3001/api/v1/prediction/2d8919bf-3426-4cf2-9a95-11f2539acff6"
        },
    ...
    public TranslationApiConfig PersianToEnglish { get; set; } = new()
    {
        Endpoints = new List<string>
        {
            "http://127.0.0.1:3001/api/v1/prediction/1e86b0ba-1193-42e3-b0ac-d56720689b0f"
        },
        DefaultEndpointIndex = 0
    };
    ...
    public TranslationApiConfig GrammarFix { get; set; } = new()
    {
        Endpoints = new List<string>
        {
            "http://127.0.0.1:3001/api/v1/prediction/2195ec5a-7b27-4fbb-8384-7c4765a6ae06"
        },
        DefaultEndpointIndex = 0
    };
    ...
    public TranslationApiConfig GrammarLearner { get; set; } = new()
    {
        Endpoints = new List<string>
        {
            "http://127.0.0.1:3001/api/v1/prediction/dfc9832f-8260-4089-91f2-6a6d8ccf6868",
            "http://localhost:3001/api/v1/prediction/9a249ec0-c176-4d27-81c6-a65f39010289"
        },
        DefaultEndpointIndex = 0
    };
}
